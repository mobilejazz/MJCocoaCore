...
/**
 * The executor. This property is readwrite internally.
 **/
@property (nonatomic, strong, readonly) MJExecutor *executor;
 ...
 **/
- (void)begin:(void (^)(void))block __attribute__((deprecated("Use -[executor submit] instead")));

/**
 * Executes a block in the main queue. Unlocks the interactor thread.
 * @discussion A `begin` call must be in corresponded to a `end` call.
 **/
- (void)end:(void (^)(void))block __attribute__((deprecated("Use -[executor submit] instead")));

/**
 * Unlock the interactor thread. This is equal to calling end with a nil block parameter.
 */
- (void)end __attribute__((deprecated("Use -[executor submit] instead")));
 ...
 **/
- (void)perform:(void (^)(void))block __attribute__((deprecated("Use -[executor submit] instead")));

/**
 * Creates a future to be used, and does the thread management.
 * @discussion When using this method, do not use neither `-begin:` nor `-end:` or `-end` methods.
 **/
- (MJFuture*)performWithFuture:(void (^)(MJFuture *future))block __attribute__((deprecated("Use -[executor ft_submit] instead")));

/**
 * YES if executing, NO otherwise. This property is KVO compliant.
 **/
@property (nonatomic, assign, readonly) BOOL isExecuting __attribute__((deprecated("Use executor.isExeucting instead")));
